...
<p align="center">
  ...
  <img alt="Pruebas" src="https://img.shields.io/badge/pruebas-620%20en%20verde-2ea043">
</p>
...
| Interfaz: componentes, reactividad, temas, listas grandes, contratos, markdown del chat, descargas | 303 |
| Interfaz: rutas de medios en cada sistema | 7 |
| Rust: hashes y análisis de audio | 14 |
| Rust: reproductor, cola, bandeja, sesión, núcleo y archivos abiertos desde fuera | 59 |
