...
<p align="center">
  ...
  <img alt="Pruebas" src="https://img.shields.io/badge/pruebas-602%20en%20verde-2ea043">
</p>
...
602 pruebas repartidas así:

| Tanda | Pruebas |
| --- | --- |
| Núcleo Python (nombres, etiquetas, duplicados, teoría, índice, descargas, Windows, asociaciones) | 108 |
| API sobre una biblioteca temporal de verdad | 105 |
| Interfaz: componentes, reactividad, temas, listas grandes, contratos, markdown del chat | 292 |
